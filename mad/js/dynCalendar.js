...
*/
	function dynCalendar_show()
	{
		...
		prevImgHTML  = '<img src="/img/calendar/prev.gif" alt="<<" border="0" />';
		prevLinkHTML = '<a href="javascript: ' + this.objName + '.show(' + previousMonth + ', ' + previousYear + ')">' + prevImgHTML + '</a>';
		nextImgHTML  = '<img src="/img/calendar/next.gif" alt="<<" border="0" />';
        ...
        */
		if (this.useMonthCombo) {
			monthComboOptions = '';
			for (var i=0; i<12; i++) {
				var selected = ((i == thisMonth.getMonth()) ? 'selected="selected"' : '');
...
*/
	function dynCalendar_writeHTML()
	{
		if (is_ie5up || is_nav6up || is_gecko) {
			document.write('<a href="javascript: ' + this.objName + '.show()"><img src="/img/calendar/dyncalendar.gif" border="0" width="16" height="16" /></a>');
