...
function openCloseAccess() {
	...
	$error_msg = "<span id='red'>Login incorrect. Please try again. </span>";" // ����� ��� ������. �����������, ��������� ������ ������ � ���������� �����</span>";
...
// if (!empty($_REQUEST['action'])) $error_msg = "Password resetting is disabled due to the demo-version limitations"; // �������������� ��������� � ����-������"; // sendNewPass();
